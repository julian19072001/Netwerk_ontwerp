...
#define BLINK_LENGHT 5                                  // Set lenght in seconds how long the identifying blink should last
#define TIME_BETWEEN_DATA 100                           // Time between data packets as defined by the ISO
